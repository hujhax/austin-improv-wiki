...
---
<noinclude>
This widget allows you to embed <b>[SoundCloud](http://www.soundcloud.com/)</b> on your wiki page.

Created by [Sergey Chernyshev](http://www.mediawikiwidgets.org/User:Sergey_Chernyshev)

## Using this widget
For information on how to use this widget, see [widget description page on MediaWikiWidgets.org](http://www.mediawikiwidgets.org/SoundCloud).

## Copy to your site
To use this widget on your site, just install [MediaWiki Widgets extension](http://www.mediawiki.org/wiki/Extension:Widgets) and copy [{{fullurl:{{FULLPAGENAME}}|action=edit}} full source code] of this page to your wiki as <b>{{FULLPAGENAME}}</b> article.
