...
## History
[[Performers/Peter Rogers|Peter Rogers]] had the original idea for the wiki on 3/17/13, at a management retreat for [[Theatres/The Hideout Theatre|The Hideout Theatre]].  [[Michael McGill]] talked about needing to collect historical information about the Austin-improv scene for a grant proposal, and how he'd have to interview many people to piece together what he needed.  Peter thought a wiki might be a simple way to gather up that historical information online.  Over the following week, Peter decided to expand the scope of the project, not just documenting the history of the scene, but everything else about the scene.

On 3/24/13, [[Performers/Bob Apthorpe|Bob Apthorpe]] created a MediaWiki installation on [[The Austin Improv Web Site]].  The next day, [[Performers/Peter Rogers|Peter Rogers]] created [the first draft of its main page](https://wiki.austinimprov.com/index.php?title=Main_Page&oldid=3), and began writing hundreds of articles.  In the following months, [[Performers/Brad Hawkins|Brad Hawkins]] created the CSS stylesheets for the wiki, with some help from [[Performers/Jon Bolden|Jon Bolden]].

Over the rest of 2013, the site began attracting spambots, leading to stricter and stricter anti-spam measures.  First, unregistered users were banned from adding external links.  Then, the account-creation process was put behind a [[Wikipedia - CAPTCHA|CAPTCHA]].  Then, account creation was changed so that it would be moderated by the wiki's maintainers.
