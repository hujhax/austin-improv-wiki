	...
	<table class="infobox infobox-performer">
		...
		<tr class="">
			<td colspan="2" class="" class="infobox-picture">
				<a href="File/Brent Chismark Pic.jpg.md"><a class="internal-link" href="File/Brent Chismark Pic.jpg.md"><img src="File/Brent%20Chismark%20Pic.jpg" alt="" style="max-width: 220px; height: auto; display: block; margin: 0 auto;" /></a></a>
			</td>
		</tr>
		<tr class="">
...
His first foray into Technical Improvising was with the 2016 run of [[Shows/Austin Secrets|Austin Secrets]] in March/April, where he worked on that show's interstitial scoring. Later, he created the "hosting" video sequences for the May/June 2016 run of [[Shows/Fiasco|Fiasco]], and was enlisted to create the opening video animation for [[Shows/How I Saved the World Over Summer Vacation|How I Saved the World Over Summer Vacation]] during that show's May/June 2017 run. 

In late 2017, he used his knowledge of TV production as a technical advisor to [[Shows/Local on the Eights|Local on the Eights]] which is the first Hideout show to include a simulated Live TV news broadcast as part of each show.
...
## Shows
* *[[Shows/Austin Secrets|Austin Secrets]]* (2016 run) (scoring)
* *[[Shows/Fiasco|Fiasco]]* (2016) (hosting videos)
* *[[Shows/How I Saved the World Over Summer Vacation|How I Saved the World Over Summer Vacation]]* (2017) (opening video animation)
* *[[Shows/Local on the Eights|Local on the Eights]]* (2017) (technical advisor)
