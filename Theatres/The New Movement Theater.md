...
<div>
	<table class="infobox infobox-theater">
		<tr>
			<th colspan="2" class="infobox-header">The New Movement</th>
		</tr>
		<tr class="">
			<td colspan="2" class="infobox-picture">
				<a href="File/TNM logo.jpg.md"><a class="internal-link" href="File/TNM logo.jpg.md"><img src="File/TNM%20logo.jpg" alt="" style="max-width: 220px; height: auto; display: block; margin: 0 auto;" /></a></a>
			</td>
		</tr>
		<tr class="">
			<th scope="row" class="category-header">Address</th>
			<td class="category">616 Lavaca Street</td>
		</tr>
		<tr class="">
			<th scope="row" class="category-header">Homepage</th>
			<td class="category">http://www.newmovementtheater.com/</td>
		</tr>
		<tr class="">
